# Microsoft Developer Studio Generated NMAKE File, Based on MQ2Medley.dsp
!IF "$(CFG)" == ""
CFG=MQ2Medley - Win32 Release
!MESSAGE No configuration specified. Defaulting to MQ2Medley - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "MQ2Medley - Win32 Release"
...
ALL : "MQ2Main - Win32 Release" "macroquest - Win32 Release" "$(OUTDIR)\MQ2Medley.dll"
...
CPP=cl.exe
CPP_PROJ=/nologo /Zp1 /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "CINTERFACE" /Fp"$(INTDIR)\MQ2Medley.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
RSC=rc.exe
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\MQ2Medley.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ..\Detours\lib60\detours.lib ..\Release\MQ2Main.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\MQ2Medley.pdb" /machine:I386 /out:"$(OUTDIR)\MQ2Medley.dll" /implib:"$(OUTDIR)\MQ2Medley.lib" /OPT:ICF 
LINK32_OBJS= \
